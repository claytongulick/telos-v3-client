...
let config = {
    ...
    cluster: {
        package_json,
        process_count: process.env.PROXY_PROCESS_COUNT,
        auto_restart: true,
        run_as: {
            enable: process.env.PROXY_RUNAS_ENABLE == '1',
            uid: process.env.PROXY_RUNAS_UID,
            gid: process.env.PROXY_RUNAS_GID,
        },
        port: process.env.PROXY_HTTP_PORT,
        listen_host: process.env.PROXY_HOST,
        ssl: {
            enable: true,
            port: 3443,
            options: {
                key: process.env.PROXY_SSL_KEY,
                cert: process.env.PROXY_SSL_CERT,
                ca: process.env.PROXY_SSL_CA
            },
        },
    },
